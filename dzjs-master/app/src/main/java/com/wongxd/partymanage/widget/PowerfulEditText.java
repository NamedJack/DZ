...
public class PowerfulEditText extends android.support.v7.widget.AppCompatEditText {
    ...
    public PowerfulEditText(Context context, AttributeSet attrs, int defStyle) {
        ...
        int color = ta.getResourceId(R.styleable.PowerfulEditText_lineColor, Color.GRAY);
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        // 画底线
        canvas.drawLine(0, this.getHeight() - 1, this.getWidth() - 1, this.getHeight() - 1, linePaint);
    }
